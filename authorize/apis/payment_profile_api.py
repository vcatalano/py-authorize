...
class PaymentProfileAPI(BaseAPI):
    ...
    def details(self, customer_id, payment_id, unmaskExpDate=False):
        return self.api._make_call(self._details_request(customer_id, payment_id, unmaskExpDate))
    ...
    def _details_request(self, customer_id, payment_id, unmaskExpDate=False):
        ...
        E.SubElement(request, 'unmaskExpirationDate').text = str(unmaskExpDate).lower()
        return request
